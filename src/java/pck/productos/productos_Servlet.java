...
public class productos_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<div class=\"bg-image\" style=\"background-image: url('https://wallpaperaccess.com/full/2133.jpg'); height: 100vh\">");
            out.println("<nav class=\"navbar navbar-dark navbar-expand-lg bg-dark\">");
            out.println("<div class=\"container-fluid\">");
            out.println("<a class=\"navbar-brand\" href=\"#\">Productos.com</a>");
            ...
            while (resultSet.next()) {
                ...
                out.println("<td><a href='eliminar_Producto_Servlet?Id=" + resultSet.getInt("Id") + "'>Eliminar</a></td>");
                out.println("</tr>");
            }
